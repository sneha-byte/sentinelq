...
import { getThreatColor, getThreatBgColor, getRouteColor } from "@/lib/mock-data"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && !incident.acknowledged && "animate-pulse-glow",
        selected
...
export function IncidentDetail({ incident, onClose, onAcknowledge, onAlertAuthorities }: IncidentDetailProps) {
  const isActive = !incident.endedAt
